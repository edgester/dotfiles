...
# Load poetry settings only if it's present
if [ -d "${HOME}/.poetry" ]; then
  export PATH="${PATH}:$HOME/.poetry/bin"

  _poetry_a1720a0f5855bf1c_complete()
  {
  ...
  complete -o default -F _poetry_a1720a0f5855bf1c_complete poetry
  complete -o default -F _poetry_a1720a0f5855bf1c_complete /home/jwedgeco/.poetry/bin/poetry
fi
